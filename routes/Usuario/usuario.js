...
router.get('/nome/:nomeUsuario', usuarioController.getUsuarioByNome); // Rota para buscar pelo nome
...
router.get('/list/usuarios', usuarioController.getAllUsuarios); // Rota para listar todos os usuários
router.post('/add/usuario', usuarioController.createUsuario); // Rota para criar um novo usuário
